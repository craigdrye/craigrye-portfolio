...
const projects = [
  {
    ...
    description: "How hot is it really getting? Tracking global temperature anomalies against climate models with near-term outlooks from the world's leading climate researchers.",
  ...
  },
  {
    ...
    description: 'Mapping the intersection of local finance and global heat. A large-scale analysis linking municipal bond yields with regional physical hazard scores.',
  ...
  },
  {
    ...
    description: 'How much does the market actually fear climate change? This real-time tracker measures global media sentiment against actual weather events to gauge financial anxiety.',
  ...
  },
  {
    tag: 'Data Analytics',
    title: 'Data Mining',
    description: 'Sifting through the noise to find the signals. Applied machine learning across vast social and economic datasets to track how narratives evolve and impact markets.',
  ...
  },
  {
    ...
    description: 'Applying the math of climate change to market volatility. Research on the non-linear physics behind economic tipping points, published in Nature Scientific Reports.',
  ...
  },
  {
    ...
    description: "A 30-year bird's-eye view of a melting continent. Visualizing three decades of satellite data to reveal the drivers of sea-level rise, as published in Nature Geoscience.",
