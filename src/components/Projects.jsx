...
const projects = [
  {
    ...
    description: 'Trend in global average temperatures compared to climate model projections, featuring predictions for 2026–2027 from the UK Met Office, Hansen, and Hausfather.',
  ...
  },
  {
    ...
    description: 'Analysis of U.S. municipal bond prices covering 47,938 bonds across 1,346 counties, integrated directly with the FEMA climate risk index.',
  ...
  },
  {
    ...
    description: 'This index tracks sentiment shifts across various media and social platforms, comparing them directly to real-world climate events with live data integration.',
  ...
  },
  {
    tag: 'Data Analytics',
    title: 'Data Mining',
    description: 'A "blue sky" exploration of media and social sentiment scores applied across a much wider range of topics.',
  ...
  },
  {
    ...
    description: 'An introduction to my quantitative work in macroeconomics, applying methods from climate dynamics and statistical physics to macroeconomic variables (published in Nature Scientific Reports).',
  ...
  },
  {
    ...
    description: 'An introduction to my research in Antarctic climate physics: a novel analysis of 30 years of satellite sea surface height data, published in Nature Geoscience.',
